...
syn keyword katahdinStatement	try catch new token 
syn keyword katahdinStatement   precedence whitespace leftRecursive rightRecursive buildTextNodes recursive dropPrecedence 
