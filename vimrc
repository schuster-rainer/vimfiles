...
" dotspaceneovim/layers {{{
  ...
  \  {'name': 'dracula/vim', 'config': {}},
  \  {'name': 'tpope/vim-commentary', 'config': {}},
  \  {'name': 'SirVer/ultisnips', 'config': {}},
  \  {'name': 'pearofducks/ansible-vim', 'config': { 'for': ['ansible', 'yaml', 'yml', 'ansible_template'], 'do': 'python UltiSnips/generate.py'}},
  \]
